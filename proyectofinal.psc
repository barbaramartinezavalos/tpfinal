Algoritmo proyecto
	...
	//Aunque hable de 20.000 alumnos, lo puse con un maximo de 5 en el algoritmo para que se entienda mejor y se llega al final mas rapido.
	//Cuando lleguen a la parte de grupos, cuando superen los 5 estudiantes, en los demas grupos pongan 0 y les saldra la parte final del sistema que creé. 
	...
	Promedio_P1=Acum_NP1/5; 
	Promedio_P2=Acum_NP2/5; 
	Promedio_P3=Acum_NP3/5; 
	Promedio_P4=Acum_NP4/5; 
	Promedio_P5=Acum_NP5/5; 
	...
	Sumatoria_Parciales=Acum_NP1+Acum_NP2+Acum_NP3+Acum_NP4+Acum_NP5; 
	// PARCIAL 1
